...
use AuthPower\Migrations\AddEmailVerifiedAtToUsers;
use AuthPower\Migrations\CreateEmailVerificationsTable;
...
switch ($argv[1]) {
    case 'migrate':
        ...
        AddEmailVerifiedAtToUsers::up();
        CreateEmailVerificationsTable::up();
        break;
    case 'make:user':
        UserSeeder::run();
        break;
